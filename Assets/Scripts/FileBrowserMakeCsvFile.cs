...
public class FileBrowserMakeCsvFile : MonoBehaviour
{ 
    ...
    IEnumerator ShowSaveDialogCoroutine()
    {
        ...
        yield return FileBrowser.WaitForSaveDialog(FileBrowser.PickMode.FilesAndFolders, false, null, null, "Save", "Save");
        // Dialog is closed
